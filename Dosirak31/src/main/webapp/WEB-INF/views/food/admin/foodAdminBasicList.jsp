<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <%@ include file="/WEB-INF/views/common/common.jspf" %> 
	...
	.li_control{width:200px; height:300px; border:1px solid black;}
         				...
         				<tr>
         					...
         					<td class="com-md-3 text-left">
	         					<div class="form-group">
	         						<input type="radio" name="food_category" class="form-control bt" value="밥류"/>밥
	         						<input type="radio" name="food_category" class="form-control bt" value="볶음류"/>볶음
	         						<input type="radio" name="food_category" class="form-control bt" value="무침류"/>무침
	         						<input type="radio" name="food_category" class="form-control bt" value="찜류"/>찜
	         						<input type="radio" name="food_category" class="form-control bt" value="김치류"/>김치
	         					</div>
         					</td>
         		...
         		<table class="table">
         			<tbody>
         				<tr>
         					...
         					<td class="com-md-3 text-left">
	         					<div class="form-group">
	         						<input type="radio" name="food_category" class="form-control bt bt2" value="밥류"/>밥
	         						<input type="radio" name="food_category" class="form-control bt bt2" value="볶음류"/>볶음
	         						<input type="radio" name="food_category" class="form-control bt bt2" value="무침류"/>무침
	         						<input type="radio" name="food_category" class="form-control bt bt2" value="찜류"/>찜
	         						<input type="radio" name="food_category" class="form-control bt bt2" value="김치류"/>김치
	         					</div>
         					</td>
         					<td class="com-md-1">음식이름</td>
         					<td class="com-md-3 text-left">
